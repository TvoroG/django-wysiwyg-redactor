...
'), e = e['replace'](/\u200B/g, '')
        ...
        image: function() {
            return {
                ...
                show: function() {
                    this['modal']['load']('image', this['lang']['get']('image'), 700), this['upload']['init']('\#redactor\-modal\-image\-droparea', this['opts']['imageUpload'], this['image']['insert']), this['modal']['show']()
                },
                insert: function(e, i, o) {
                    var r;
                    if ('undefined' != typeof e['error']) {
                    ...
                    if (i) {
                        ...
                        var c = this['insert']['nodeToPoint'](o, this['marker']['get']()),
                            d = t(c)['next']();
                        this['selection']['restore'](), this['buffer']['set'](), 'undefined' != typeof d && 0 !== d['length'] && 'IMG' === d[0]['tagName'] ? (this['core']['callback']('imageDelete', d[0]['src'], d), d['closest']('figure\,\ p', this['core']['editor']()[0])['replaceWith'](s), this['caret']['after'](s)) : (l ? t(l)['after'](s) : this['insert']['node'](s), this['caret']['after'](s))
                    } else {
                        this['modal']['close'](), this['buffer']['set'](), this['air']['collapsed'](), l ? t(l)['after'](s) : this['insert']['node'](s), this['caret']['after'](s)
                    };
